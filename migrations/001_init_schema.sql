...
-- FASE 3: Columna 'archivado' para catálogos flexibles (Sección III SGC2I)
ALTER TABLE AREA ADD COLUMN archivado BOOLEAN DEFAULT FALSE;
ALTER TABLE CARGO ADD COLUMN archivado BOOLEAN DEFAULT FALSE;
ALTER TABLE TIPO_COMUNICADO ADD COLUMN archivado BOOLEAN DEFAULT FALSE;
ALTER TABLE MEDIO_RECEPCION ADD COLUMN archivado BOOLEAN DEFAULT FALSE;
ALTER TABLE ROL_DESTINATARIO ADD COLUMN archivado BOOLEAN DEFAULT FALSE;
ALTER TABLE ROL_RESPONSABLE ADD COLUMN archivado BOOLEAN DEFAULT FALSE;